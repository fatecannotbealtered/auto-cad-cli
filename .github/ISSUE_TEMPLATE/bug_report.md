---
name: Bug Report
about: Report a bug in auto-cad-cli
title: "[Bug] "
labels: bug
assignees: ''
---
...
- **auto-cad-cli version**: (run `auto-cad-cli --version`)
...
<details>
<summary><code>auto-cad-cli doctor</code> output</summary>

```
(paste the output of `auto-cad-cli doctor` here)
```
